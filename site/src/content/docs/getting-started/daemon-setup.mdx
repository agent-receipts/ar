...
Homebrew installs both the `obsigna-daemon` and `agent-receipts` (verify) binaries.
...
chain_id = "2026-06-13"               # --chain-id (defaults to the current UTC date when omitted)
