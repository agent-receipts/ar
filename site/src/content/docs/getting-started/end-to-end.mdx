...
You should see one row: sequence `1`, tool `fs.write_file`, chain `2026-06-13`
(the daemon names each day's chain by the current UTC date).
...
Run `agent-receipts show 2` (or substitute the sequence of
