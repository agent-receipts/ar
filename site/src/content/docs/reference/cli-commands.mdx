---
title: CLI Commands
description: Command reference for the Agent Receipts CLI tools — the mcp-proxy policy proxy, the agent-receipts read/verify CLI, and obsigna-hook.
---
