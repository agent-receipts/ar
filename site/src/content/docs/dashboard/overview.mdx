...
![Dashboard overview showing stats, risk distribution, and recent receipts](https://raw.githubusercontent.com/agent-receipts/dashboard/main/docs/screenshot.png)
