...
The plugin holds no key of its own — `agent-receipts-daemon` owns the key and signs every receipt ([ADR-0010](https://github.com/agent-receipts/ar/blob/main/docs/adr/0010-daemon-process-separation.md)). Initialise it once and start it before launching OpenCode:
