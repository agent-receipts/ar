 ...
 * (cross-sdk-tests/emit_failure_vectors.json, ADR-0023). Loads the vector,
 ...
 * EmitTransportError instances (ADR-0023); caller bugs are plain Error
...
describe("emit failure contract vector (ADR-0023)", () => {
