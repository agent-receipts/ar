...
var (
	...
	SystemActions = []ActionTypeEntry{
		...
		{Type: "system.pty.open", Description: "Open an interactive PTY session", RiskLevel: receipt.RiskCritical},
		{Type: "system.pty.close", Description: "Close a PTY session", RiskLevel: receipt.RiskCritical},
