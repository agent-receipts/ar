...
| [ADR-0026](0026-reversibility-taxonomy-and-cascade-model.md) | Reversibility Taxonomy and Cascade Model | Accepted |
| [ADR-0027](0027-attribution-primary-product-model.md) | Attribution-Primary Product Model | Accepted |
