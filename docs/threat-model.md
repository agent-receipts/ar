...
- **`parameterDisclosure` (ADR-0012) is not yet uniform across emitters.** The TS SDK has the field; Python and Go SDKs do not. The MCP proxy uses a different (symmetric) scheme via `BEACON_ENCRYPTION_KEY`.
